...
/**
 * Clase auxiliar encargada de facilitar la síntaxis para el renderizado de las páginas
 *
...
public class ViewUtil {
     ...
     * @param model El modelo de datos enviado a la plantilla de la página web
